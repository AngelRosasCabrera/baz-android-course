...
data class BitsoResponse(
    @SerializedName("payload") @Expose val payload: List<BitsoModel>,
...
data class BitsoModel(
    ...
    @SerializedName("fees") @Expose val fees: FeesModel,
...
data class FeesModel(
    @SerializedName("flat_rate") @Expose val flatRate: FlatRateModel,
    @SerializedName("structure") @Expose val structure: List<StructureModel>
)
